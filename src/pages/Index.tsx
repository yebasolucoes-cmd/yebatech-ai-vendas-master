  ...
  return <div className="min-h-screen flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="relative">
                ...
                <div className="bg-yebatech-blue p-3 rounded-2xl shadow-lg">
                  <img alt="Médica usando inteligência artificial" src="/lovable-uploads/23aa1c27-84ec-42fa-b80d-473c302617bb.jpg" className="w-full h-auto rounded-xl" />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 mb-8">
                {["Como montar um fluxo automatizado de atendimento no WhatsApp usando IA", "Técnicas para aumentar a taxa de conversão de consultas em 67%", "Como reduzir em até 80% o tempo gasto com tarefas administrativas", "Estratégias para reativar pacientes antigos de forma automática", "Template pronto para implementação imediata em sua clínica"].map((item, index) => <li key={index} className="flex items-start">
              ...
              <CTAButton text="QUERO GARANTIR MINHA VAGA" link="/checkout" variant="primary" className="mb-4" />
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <CTAButton text="GARANTIR MINHA VAGA" link="/checkout" variant="outline" className="border-white text-white hover:bg-white/20" />
            </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <Testimonial author="Dr. Ricardo Santos" role="Clínica Ortopédica" quote="Após implementar o sistema, vi uma redução de 65% nas faltas de pacientes e um aumento de 40% nos agendamentos. O ROI foi impressionante." rating={5} image="https://i.pravatar.cc/150?img=11" />
            
            <Testimonial author="Dra. Ana Martins" role="Dermatologista" quote="Minha secretária consegue focar em tarefas mais importantes agora que o sistema cuida dos agendamentos. Pacientes adoram a praticidade!" rating={5} image="https://i.pravatar.cc/150?img=5" />
            
            <Testimonial author="Dr. Paulo Mendes" role="Clínica Odontológica" quote="Em apenas 2 semanas usando o sistema, conseguimos recuperar pacientes antigos e preencher horários que ficavam vazios. Muito satisfeito!" rating={4} image="https://i.pravatar.cc/150?img=15" />
          </div>
        </div>
      </section>
                ...
                <div className="text-center">
                  ...
                  <div className="bg-white/10 rounded-xl p-6 mb-8 backdrop-blur-sm">
                    ...
                    <ul className="space-y-3 mb-6">
                      {["Acesso vitalício à gravação da Aula Magna", "Templates prontos para implementação", "Guia passo a passo para configurar o sistema", "Acesso ao grupo de suporte exclusivo", "Bônus: E-book \"Retenção de Pacientes com IA\""].map((item, index) => <li key={index} className="flex items-start text-white">
                    ...
                    <div className="text-center">
                      ...
                      <CTAButton text="GARANTIR MINHA VAGA AGORA" link="/checkout" variant="primary" fullWidth className="text-lg py-4" />
      ...
      <section className="section-padding bg-yebatech-lightGreen">
        <div className="container-custom text-center">
          ...
          <CTAButton text="SIM, QUERO ME INSCREVER AGORA!" link="/checkout" variant="primary" className="text-lg py-3 px-8" />
